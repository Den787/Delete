...
(function($) {
  ...
  var defaults = {
    ...
    onBeforeUpload: function(id, widget){},
    onComplete: function(){},
  ...
  DmUploader.prototype.processQueue = function()
  {
    ...
    var can_continue = widget.settings.onBeforeUpload.call(widget.element, widget.queuePos, widget);
      ...
      xhr: function(){
        ...
        if(xhrobj.upload){
          xhrobj.upload.addEventListener('progress', function(event) {
            ...
            widget.settings.onUploadProgress.call(widget.element, widget.queuePos, percent, widget.queue.length);
          }, false);
        }
